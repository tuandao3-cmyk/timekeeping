...
const ProjectGrid: React.FC = () => {
  return (
    <>
      <Marquee autoFill className="!hidden md:!flex items-center bg-[#F3F7F4] py-[40px] lg:py-[62px]">
      <Image
        width={257}
        height={82}
      ...
      />
        ...
        <div className="md:hidden grid grid-cols-2 items-center justify-items-center grid-rows-5 gap-y-4 gap-x-0 bg-[#F3F7F4] py-[40px] ">
        ...
        <a href="https://vitalaretail.vn/" target="_blank" rel="noopener noreferrer">
          <Image
            width={257}
            height={82}
            src="/img/icon/coop2.png"
        ...
        <a href="https://www.eurekainternational.com.au/" target="_blank" rel="noopener noreferrer">
          <Image
            width={257}
            height={82}
            src="/img/icon/coop7.png"
        ...
        <a href="https://corex.network" target="_blank" rel="noopener noreferrer">
          <Image
            width={257}
            height={82}
            src="/img/icon/coop8.png"
