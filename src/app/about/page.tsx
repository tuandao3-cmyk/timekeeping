...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#07212C] min-h-[820px]  w-[100%] flex flex-col justify-center items-center relative px-32">
          ...
          <div className="flex justify-between items-center h-auto w-full mt-16 max-md:!flex-col">
            ...
            <div className="flex-1 flex flex-col gap-[32px] justify-end items-end">
              ...
              >
                ...
                small-to-medium enterprises, fostering creativity, innovation,
      ...
      <div className="pt-32 bg-[#F3F7F4]" />
      <Partner />
      <div className={styles['about-container']}>
        <section
          className={`flex flex-col w-full justify-center items-center bg-white`}
        >
          <div className="max-w-[1200px] flex flex-row-reverse justify-between items-center gap-[40px]">
            <div className={styles.textContent}>
              <h2
                ref={ref2}
                className={` duration-700 ease-in-out transform font-bold text-[40px] leading-[48px] ${
                  inView2
        ...
        <section className={`${styles.mission} py-[62px]`}>
          <div className="flex flex-row justify-between items-center gap-[40px] max-w-[1200px]">
            <div className={styles.textContent}>
              <h2
                ref={ref3}
                className={` duration-700 ease-in-out transform ${
        ...
        <section className={styles.values}>
          <div className="flex flex-col justify-between items-center gap-[40px] max-w-[1200px]">
