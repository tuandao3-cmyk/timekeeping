...
const feedbacks = [
  ...
  },
  {
    id: 2,
    content:
      'Đa dạng dự án, thông tin rõ ràng, lợi nhuận tốt Dù đầu tư ngắn hạn, trung hạn hay dài hạn, HyraCap đều có thể đáp ứng',
    name: 'Vũ Phương Tuấn',
  ...
  },
  {
    id: 3,
    content:
      'Tôi đã đúng khi đặt niềm tin vào HyraCap Nhờ HyraCap, tôi đã tạo ra nguồn thu nhập thụ động đầu tiên ở tuổi 40',
