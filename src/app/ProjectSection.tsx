...
const ProjectSection = () => {
                  ...
                  <div className={styles.projectInfo}>
                    ...
                    <div className="flex gap-2 mt-2">
                      {project.category.map((cat, index) => (
                          <span key={index} className="bg-[#000000]/10 text-[#000000]/70 font-inter leading-4 px-2 py-1  text-xs font-medium">
                          {cat}
                        </span>
                      ))}
                    </div>
  ...
  TÌM HIỂU THÊM CÁC DỰ ÁN <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
