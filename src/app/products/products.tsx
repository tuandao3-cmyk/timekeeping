  ...
  return (
    <>
      ...
      <section className="w-full h-auto mt-[1420px] sm:mt-[250px] md:mt-[250px] lg:mt-[350px] lg bg-white py-2 xl:py-6 flex flex-col justify-center items-center xl:px-[120px] ">
        ...
        <button
          onClick={() => (window.location.href = `/categories`)}
          className="border-[#0000003D] border-[1px] rounded-[999px] py-[8px] px-[12px] font-[500] text-[16px] text-black text-opacity-90 hover:bg-[#48B96D] hover:text-white transform ease-in-out duration-100 hover:border-transparent sm:hidden"
        >
