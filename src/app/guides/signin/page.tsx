  ...
  return (
    <>
      <main className=" lg:pt-[50px] pt-0 px-8 pb-[30px]  lg:px-[70px] text-black text-left font-sans">
        ...
        <h1 className=" text-3xl 3xl:text-4xl font-bold ">
          Các bước thực hiện
        </h1>
        ...
        <ul className=" text-xl 3xl:text-2xl leading-7 text-[#000000] text-left">
          ...
          <li className="pl-2">
            Bước 2: Tải app HyraCap về điện thoại của bạn.
          </li>
        ...
        <p className="mt-5 font-normal text-left text-xl 3xl:text-2xl">
          Như vậy, HyraCap đã thực hiện xong phần hướng dẫn Đăng ký sử dụng ứng
          dụng HyraCap.
          <br />
