    ...
    <>
      <main className=" lg:pt-[50px] pt-0 px-8 pb-[30px]  lg:px-[70px] text-black text-left font-sans ">
        ...
        <ul className=" text-xl 3xl:text-2xl leading-7 text-[#000000] text-left">
          ...
          <li className="pl-2">
            Tại màn hình Giao dịch cho phép người dùng theo dõi và tìm kiếm gói
            đầu tư
          </li>
        </ul>
        ...
        <ul className=" text-xl 3xl:text-2xl leading-7 text-[#000000] pl-4 ">
          <li className="pl-2">
            Bước 2: Chọn vào gói đầu tư hiển thị thông tin chi tiết về gói đang
            đầu tư
          </li>
          <li className="pl-2">
            Bạn có thể theo dõi lợi nhuận theo dòng thời gian tại màn hình chi
            tiết này.
          </li>
        </ul>
        {/* Phần hình ảnh cuối */}
        ...
        <p className="mt-5 font-normal text-left text-xl 3xl:text-2xl">
          Như vậy, HyraCap đã thực hiện xong phần hướng dẫn theo dõi giao dịch
          đầu tư trên ứng dụng HyraCap.
          <br />
