            ...
            <div className={styles.contentContainer}>
                ...
                <nav>
                        <ul>
                            ...
                            <li>
                                <Link href="/guides/login" className={pathname === '/guides/login' ? styles.active : ''}>
                                    Đăng nhập
                                </Link>
                            </li>
                            <li>
                ...
                <main className={styles.mainContent}>
                    {/* <h2 className={styles.sidebar}>Hướng dẫn&gt;Đăng ký</h2> */}
                    ...
                    <ul>
                        <li>Bước 1: Trên điện thoại vào vào <strong>Appstore</strong> hoặc <strong>Google Play</strong></li>
                    ...
                    <li>Bước 4: Nhập mã xác thực OTP và bấm Tiếp tục
