    ...
    <>
      <main className=" lg:pt-[50px] pt-0 px-8 pb-[30px]  lg:px-[70px] text-black text-left font-sans ">
        ...
        <ul className=" text-xl 3xl:text-2xl leading-7 text-[#000000] text-left">
          ...
          <li className="pl-2">Bước 2: Chọn gói sản phẩm đầu tư phù hợp</li>
        </ul>
        ...
        <ul className=" text-xl 3xl:text-2xl leading-7 text-[#000000] pl-4 ">
          ...
          <li className="pl-2">
            Hệ thống sẽ tự động tính lãi suất từng quý dựa trên số tiền đầu tư
            và kỳ hạn bạn chọn
          </li>
        </ul>
        {/* Phần hình ảnh cuối */}
        ...
        <ul className=" text-xl 3xl:text-2xl leading-7 text-[#000000] pl-4 ">
          <li className="pl-2">Bước 4: Xác nhận giao dịch</li>
        ...
        <ul className=" text-xl 3xl:text-2xl leading-7 text-[#000000] pl-4 ">
          <li className="pl-2">Bước 5: Chuyển khoản ngân hàng</li>
          <li className="pl-2">
            Thực hiện chuyển khoản bằng mã QR trên ứng dụng hoặc chuyển qua số
            tài khoản của <strong>HyraCap</strong>.
          </li>
          <li className="pl-2">
            Bạn có thể theo dõi quá trình đầu tư của mình tại tính năng{' '}
        ...
        <p className="mt-5 font-normal text-left text-xl 3xl:text-2xl">
          Như vậy, HyraCap đã thực hiện xong phần hướng dẫn thực hiện đầu tư sử
          dụng ứng dụng HyraCap.
          <br />
