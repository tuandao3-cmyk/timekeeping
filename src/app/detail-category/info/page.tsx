            ...
            <div className="w-full lg:w-1/3 sm:flex sm:gap-3 xs:block md:block lg:block">
              <div>
                ...
                <p className="text-base font-bold text-white">
                  ...
                  vòng đầu tư Series C. Nguồn đầu tư mới nhất được huy động vào
                  ngày 10/10/2024.Với 20 slot được tài trợ bởi 18 nhà đầu tư.
                </p>
              </div>
              <img
                src="/img/raise.png"
            ...
            <div className="bg-white py-6 px-11 rounded-lg shadow-lg">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-5">
                ...
                <li className="flex">
                  <div className="m-3 w-1 h-1 rounded-full bg-[#444444]"></div>
                  <div className="text-lg font-normal">
                    <span className="text-[#444444]">Tình trạng hoạt động</span>
              ...
              <p className="mt-4 text-lg font-normal text-black">
                ...
                luyện mô hình AI ngay trên thiết bị của bạn và hỗ trợ huấn luyện
                phát triển mô hình AI trên cloud.
              </p>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="p-2 pt-6">
                      ...
                      hình học máy hoặc mạng nơ-ron học từ dữ liệu để thực hiện
                      một nhiệm vụ cụ thể, chẳng hạn như phân loại hình ảnh,
                      nhận dạng giọng nói, dự đoán, hoặc đưa ra quyết định.
                    </td>
                  </tr>
                  <tr>
                    <td className="pl-8 pt-6">
                    ...
                    <td className="p-2 pt-6">
                      ...
                      với nơi dữ liệu được tạo ra hoặc thu thập, thay vì chuyển
                      toàn bộ dữ liệu về một trung tâm dữ liệu hoặc đám mây để
                      xử lý. Mục tiêu chính của điện toán biên là giảm độ trễ,
                      tiết kiệm băng thông và cải thiện hiệu suất ứng dụng.
                    </td>
                  </tr>
                  <tr>
