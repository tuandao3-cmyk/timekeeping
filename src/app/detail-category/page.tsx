            ...
            <main className=" bg-[#F7F9FC]">
                <div className="py-6   rounded-lg shadow-md">
                    ...
                    <div className="flex flex-col md:flex-row lg:flex-row gap-4 bg-white px-11 py-10">
                        <div className="w-full md:w-1/3 lg:w-1/3">
                            ...
                            <p className="font-normal text-lg">
                                Salala là một nền tảng điện toán biên cho phép
                                người dùng tận dụng phần cứng của các thiết bị
                                biên (edge devices) để huấn luyện mô hình trí
                                tuệ nhân tạo (AI).
                            </p>
                            <div className="mt-4 text-lg font-normal text-[#666666]">
                                <p>
                                    📍 10 Anson Road #11 - 20 International
                                    Plaza Singapore
                                </p>
                                <p>👥 150 - 200</p>
                                <p>
                            ...
                            <div className="space-y-2 text-gray-500">
                                <div className="flex items-start gap-2">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <p>
                                            Dự án SalalaAI tăng trưởng mạnh mẽ
                                            với lượng thiết bị tăng liên tục với
                                            lượt tải đã đạt trên 1M
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-2">
                    ...
                    <div
                        style={{
                            background:
                                "linear-gradient(90deg, #2A7082 0%, #73E097 100%)",
                        }}
                            ...
                            <div className="w-full lg:w-1/3 sm:flex sm:gap-3 xs:block md:block lg:block">
                                <div>
                                    ...
                                    <p className="text-base font-bold text-white">
                                        Dự án Salala AI đã huy đông được tổng
                                        cộng 220,5 triệu đô la vòng đầu tư
                                        Series C. Nguồn đầu tư mới nhất được huy
                                        động vào ngày 10/10/2024.Với 20 slot
                                        được tài trợ bởi 18 nhà đầu tư.
                                    </p>
                                </div>
                                <img
                                    src="/img/raise.png"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="bg-white py-6 px-11 rounded-lg shadow">
                                ...
                                <p className="mt-4 text-lg font-normal text-black">
                                    Dự án Salala là một ứng dụng di động chuyên
                                    cung cấp các giải pháp huấn luyện trí tuệ
                                    nhân tạo (AI) trên các thiết bị biên. Phạm
                                    vi của dự án bao gồm việc phát triển các
                                    tính năng huấn luyện mô hình AI ngay trên
                                    thiết bị của bạn và hỗ trợ huấn luyện phát
                                    triển mô hình AI trên cloud.
                                </p>
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td className="pl-8 pt-6">
                                                Huấn luyện AI <br /> (Training
                                                AI)
                                            </td>
                                            <td className="p-2 pt-6">
                                                Training AI (Huấn luyện AI) là
                                                quá trình trong đó một mô hình
                                                học máy hoặc mạng nơ-ron học từ
                                                dữ liệu để thực hiện một nhiệm
                                                vụ cụ thể, chẳng hạn như phân
                                                loại hình ảnh, nhận dạng giọng
                                                nói, dự đoán, hoặc đưa ra quyết
                                                định.
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="p-2 pt-6">
                                                ...
                                                là một mô hình tính toán phân
                                                tán trong đó việc xử lý dữ liệu
                                                được thực hiện gần với nơi dữ
                                                liệu được tạo ra hoặc thu thập,
                                                thay vì chuyển toàn bộ dữ liệu
                                                về một trung tâm dữ liệu hoặc
                                                đám mây để xử lý. Mục tiêu chính
                                                của điện toán biên là giảm độ
                                                trễ, tiết kiệm băng thông và cải
                                                thiện hiệu suất ứng dụng.
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td className="p-2 py-6">
                                                Là tập hợp các thiết bị active
                                                do người dùng trực tiếp giới
                                                thiệu.
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-4 text-xl font-normal">
                                    ...
                                    <li>
                                        Những lợi ích đầu tư và HyraCap là gì?
                                    </li>
                                    <li>
                                        Làm sao để tận dụng các lợi thế trên
                                        HyraCap?
                                    </li>
                                    <li>
                                        Mạng lưới tập trung định hình tương lai
                                        của AI?
                                    </li>
                                </ul>
