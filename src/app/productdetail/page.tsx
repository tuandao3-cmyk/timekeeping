      ...
      <div className={styles.container}>
        ...
        <div className={styles.info}>
          ...
          <p>
            ...
            phần cứng của các thiết bị biên (edge devices) để huấn luyện mô hình
            trí tuệ nhân tạo (AI).
          </p>
        ...
        <div className={styles.activity}>
          ...
          <p>
            Tin tức 10/10/2024: Dự án Salala AI tăng trưởng mạnh mẽ với lượng
            thiết bị tăng liên tục với lượt tải đã đạt trên 1M.
          </p>
          <p>
            Tin tức 8/10/2024: Dự án Salala AI tăng trưởng mạnh mẽ với lượng
            thiết bị tăng liên tục với lượt tải đã đạt trên 1M.
          </p>
          <p>
            Tin tức 10/10/2024: Dự án Salala AI tăng trưởng mạnh mẽ với lượng
