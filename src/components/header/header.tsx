...
const Header = () => {
  ...
  return (
    ...
    >
      <nav className={`bg-white md:bg-transparent  px-4 lg:px-6 py-2.5  `}>
        <div
          className={`flex flex-wrap ${isVisible ? 'lg:justify-center justify-between' : 'justify-between'} items-center mx-auto max-w-[1200px] md:px-[120px  ]`}
        >
          <Link
            href="/"
            className={`  items-center mr-3 h-6 sm:h-9 md:w-[118px] max-w-[118px]  `}
          >
            <Image
              width={98}
              height={40}
              ...
              layout="responsive"
              className={`mr-3 h-6 sm:h-9 md:w-[118px] max-w-[118px] ${isVisible ? 'md:hidden' : 'md:block'}  `}
              alt="HyraCap Logo"
            />
          </Link>
          <>
