              ...
              ? [1, 2, 3].map((item, index) => (
                  ...
                  >
                    <a
                      ref={ref}
                      href={`#`}
                      className={`bg-[#07212C] w-full rounded-xl overflow-visible transition duration-100 md:max-h-[386px] pb-[20px] gap-[24px] max-w-[778px] flex flex-col p-[12px] md:p-[32px] md:flex-row`}
                      data-aos="fade-right"
                      ...
                      >
                        <div className="w-full h-full flex flex-col justify-center items-center rounded-lg overflow-hidden">
                          ...
                          <Skeleton
                            ...
                            className=" font-sans top-[90%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-green-500 text-white px-4 py-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer text-center"
                          />
                        </div>
                      </div>
                      <div className="md:w-1/2 w-full flex flex-col gap-[28px]">
                        <div className="flex flex-col gap-[8px]">
                          <Skeleton
                            ...
                            className="top-4 left-4 text-[#0298F4] px-2 py-1 text-xs rounded inline-flex w-fit items-center "
                          />
                          ...
                          <Skeleton
                            ...
                            className="text-2xl font-semibold leading-8 text-white mb-2 font-sans"
                          />
                          ...
                          <Skeleton
                            ...
                            className="text-gray-300 leading-6 text-sm mb-4 font-sans line-clamp-2 text-ellipsis overflow-x-hidden"
                          />
                        </div>
                        ...
                        <Skeleton
                          ...
                          className="rounded-lg max-sm:m-1 transition-all duration-300 p-[12px]"
                        />
                        ...
                        <Skeleton
                          ...
                          className="flex gap-2  pt-[16px] h-[24px]"
                        />
                      </div>
                    </a>
                  </SwiperSlide>
