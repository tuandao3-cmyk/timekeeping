...
const ContactInfo = () => {
  return (
    <div className="flex flex-col gap-6 flex-1 p-8 border rounded-lg shadow-lg h-full">
      <h2 className="font-noto font-medium text-[32px] leading-[40px]">
        Thông tin liên hệ
      </h2>
      <div className="flex flex-col gap-4">
        <p className="flex items-center font-noto text-base leading-6 tracking-tight">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          >
            <g clipPath="url(#clip0_1419_1171)">
              <path
        ...
        <p className="flex items-center font-noto text-base leading-6 tracking-tight">
          <svg
            ...
            className="mr-2"
          >
            <g clip-path="url(#clip0_1419_1174)">
              <path
            ...
            <defs>
              <clipPath id="clip0_1419_1174">
                <rect width="24" height="24" fill="white" />
              </clipPath>
            </defs>
          </svg>
          info@hyracapital.com
        </p>
        <p className="flex items-center font-noto text-base leading-6 tracking-tight">
          <svg
            width="24"
            ...
            className="mr-2"
          >
            <g clip-path="url(#clip0_1419_1177)">
              <path
        ...
        <p className="flex items-center font-noto text-base leading-6 tracking-tight">
          <svg
            ...
            className="mr-2"
          >
            <g clip-path="url(#clip0_1419_1180)">
              <path
                d="M3 21H21"
                stroke="#1F1F1F"
                stroke-width="2"
            ...
            <defs>
              <clipPath id="clip0_1419_1180">
                <rect width="24" height="24" fill="white" />
              </clipPath>
            </defs>
          </svg>
          A Lô CX01, khu đô thị Văn Khê, phường La Khê, quận Hà Đông, Hà Nội,
          Việt Nam
        </p>
      </div>
      <div className="mt-4">
